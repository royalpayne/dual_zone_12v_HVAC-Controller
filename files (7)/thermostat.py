...
class ThermostatController:
    ...
    def _heat_on(self):
        """Turn on heating"""
        print(f"HEAT ON (temp: {self.current_temp:.1f}F, setpoint: {self.heat_setpoint}F)")
    ...
    def _heat_off(self):
        """Turn off heating"""
        print(f"HEAT OFF (temp: {self.current_temp:.1f}F, setpoint: {self.heat_setpoint}F)")
    ...
    def _cool_on(self):
        """Turn on cooling"""
        print(f"COOL ON (temp: {self.current_temp:.1f}F, setpoint: {self.cool_setpoint}F)")
    ...
    def _cool_off(self):
        """Turn off cooling"""
        print(f"COOL OFF (temp: {self.current_temp:.1f}F, setpoint: {self.cool_setpoint}F)")
