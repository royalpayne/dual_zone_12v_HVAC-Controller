...
class BME280:
    ...
    def read(self):
        ...
        Returns: (temp_celsius, pressure_hpa, humidity_percent)
        """
        ...
        # Compensate pressure (convert Pa to hPa)
    ...
    def read_fahrenheit(self):
        """
        Read temperature in Fahrenheit, pressure in hPa, humidity in %
        Returns: (temp_fahrenheit, pressure_hpa, humidity_percent)
        """
        temp_c, pressure_hpa, humidity = self.read()
        temp_f = (temp_c * 9/5) + 32
        return temp_f, pressure_hpa, humidity
